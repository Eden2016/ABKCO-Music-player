...
!function(t,o){"use strict";"function"==typeof define&&define.amd?define(["../layout-mode","masonry/masonry"],o):"object"==typeof exports?module.exports=o(require("../layout-mode"),require("masonry-layout")):o(t.Isotope.LayoutMode,t.Masonry)}(window,function(t,o){"use strict";function e(t,o){for(var e in o)t[e]=o[e];return t}var i=t.create("masonry"),r=i.prototype._getElementOffset,p=i.prototype.layout,s=i.prototype._getMeasurement;e(i.prototype,o.prototype),i.prototype._getElementOffset=r,i.prototype.layout=p,i.prototype._getMeasurement=s;var n=i.prototype.measureColumns;i.prototype.measureColumns=function(){this.items=this.isotope.filteredItems,n.call(this)};var a=i.prototype._manageStamp;return i.prototype._manageStamp=function(){this.options.isOriginLeft=this.isotope.options.isOriginLeft,this.options.isOriginTop=this.isotope.options.isOriginTop,a.apply(this,arguments)},i});
...
!function(t,e){"function"==typeof define&&define.amd?define(["isotope/js/layout-mode"],e):"object"==typeof exports?module.exports=e(require("isotope-layout/js/layout-mode")):e(t.Isotope.LayoutMode)}(window,function(t){"use strict";var e=t.create("horizontal",{verticalAlignment:0}),i=e.prototype;return i._resetLayout=function(){this.x=0},i._getItemLayoutPosition=function(t){t.getSize();var e=(this.isotope.size.innerHeight-t.size.outerHeight)*this.options.verticalAlignment,i=this.x;return this.x+=t.size.outerWidth,{x:i,y:e}},i._getContainerSize=function(){return{width:this.x}},i.needsResizeLayout=function(){return this.needsVerticalResizeLayout()},e});
...
!function(t,e){"use strict";"function"==typeof define&&define.amd?define(["isotope/js/layout-mode","packery/js/packery","get-size/get-size"],e):"object"==typeof exports?module.exports=e(require("isotope-layout/js/layout-mode"),require("packery"),require("get-size")):e(t.Isotope.LayoutMode,t.Packery,t.getSize)}(window,function(t,e,o){"use strict";function i(t,e){for(var o in e)t[o]=e[o];return t}var r=t.create("packery"),p=r.prototype._getElementOffset,s=r.prototype._getMeasurement;i(r.prototype,e.prototype),r.prototype._getElementOffset=p,r.prototype._getMeasurement=s;var n=r.prototype._resetLayout;r.prototype._resetLayout=function(){this.packer=this.packer||new e.Packer,n.apply(this,arguments)};var a=r.prototype._getItemLayoutPosition;r.prototype._getItemLayoutPosition=function(t){return t.rect=t.rect||new e.Rect,a.call(this,t)};var y=r.prototype._manageStamp;return r.prototype._manageStamp=function(){this.options.isOriginLeft=this.isotope.options.isOriginLeft,this.options.isOriginTop=this.isotope.options.isOriginTop,y.apply(this,arguments)},r.prototype.needsResizeLayout=function(){var t=o(this.element),e=this.size&&t,i=this.options.isHorizontal?"innerHeight":"innerWidth";return e&&t[i]!=this.size[i]},r});
...
ID.modules["destroy-demo"]=function(o){"use strict";var t=$(o),i={masonry:{columnWidth:50}},n=t.find(".grid").isotope(i),e=!0;t.find(".toggle-button").on("click",function(){e?n.isotope("destroy"):n.isotope(i),e=!e})};
